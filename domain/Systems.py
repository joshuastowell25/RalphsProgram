...
class Stat:
    ...
    def print(self):
        headingWidth = 43
        print('GRAND TOTAL:'.ljust(headingWidth) + str(format(self.runningGt[-1], '.2f')))
        print('TRADE COUNT:'.ljust(headingWidth) + str(format(self.runningTradeCount[-1], '.2f')))
        print('WIN COUNT:'.ljust(headingWidth) + str(format(self.runningWinCount[-1], '.2f')))
        print('LOSS COUNT:'.ljust(headingWidth) + str(format(self.runningLossCount[-1], '.2f')))
        print('AVG WIN:'.ljust(headingWidth) + str(format(float(self.runningWinTotal[-1])/float(self.runningWinCount[-1]), '.2f')) if self.runningWinCount[-1] > 0 else 0)
        print('AVG LOSS:'.ljust(headingWidth) + str(format(float(self.runningLossTotal[-1])/float(self.runningLossCount[-1]), '.2f')) if self.runningLossCount[-1] > 0 else 0)
        print('MAX WIN:'.ljust(headingWidth) + str(format(self.runningMaxWin[-1], '.2f')))
        print('MAX LOSS:'.ljust(headingWidth) + str(format(self.runningMaxLoss[-1], '.2f')))
        print('W/L RATIO:'.ljust(headingWidth) + str(format(float(self.runningWinCount[-1])/float(self.runningLossCount[-1]), '.2f')) if self.runningLossCount[-1] > 0 else "N/A")
        print('L/W RATIO:'.ljust(headingWidth) + str(format(float(self.runningLossCount[-1])/float(self.runningWinCount[-1]), '.2f')) if self.runningWinCount[-1] > 0 else "N/A")
        print('VARIANCE:'.ljust(headingWidth) + str(format(float(self.variance), '.2f')))
